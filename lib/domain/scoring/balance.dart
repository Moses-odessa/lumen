...
abstract final class SessionBalance {
  ...
  ///
  /// Из трёх слов порядок угадать проще, чем вспомнить: перестановок шесть, и
  /// половина из них по-немецки допустима. Задание, которое проходится
  /// перебором, не проверяет ничего. TODO(balance)

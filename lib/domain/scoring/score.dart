...
abstract final class ScoreRules {
  ...
  // `paceFor` удалён вместе с многослотовым ответом.
  //
  // Он делил время ответа на число размещений: фразовая арена сообщала время
  // до последней плитки, а пороги «быстро» и «легко» рассчитаны на один тап,
  // поэтому всякая верно собранная фраза записывалась как `hard` и сбрасывала
  // серию «горящей звезды». Ответ теперь один на круг — делить не на что, и
  // приведение стало тождеством.

  /// Приносит ли режим очки на фразе такой яркости.
  ///

...
abstract final class SkyLayout {
  ...
  /// любом числе созвездий от девяти до тридцати: оно зависит только от
  ...
  /// Расчётный объём курса: ~30 созвездий. Больше — спираль просто
  /// продолжится за пределы единичного круга, и карту нужно будет
  /// отмасштабировать, а не переложить.
  ///
  /// Словник из 6000 лемм даёт 24 темы, то есть в этот запас укладывается.
  ...
  static const double _minCenterDistance = 0.1185517;

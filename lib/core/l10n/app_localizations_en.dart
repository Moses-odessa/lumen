...
class AppLocalizationsEn extends AppLocalizations {
  ...
  String calibrationResultVocabulary(int count) {
    return 'About $count phrases of the course lie on this tier and below.';
  }
  ...
  @override
  String get calibrationResultRecognised => 'Phrases you recognised';
  ...
  String calibrationResultCapped(String tier) {
    return 'Only $tier is open so far, so the sky begins there. It is not the ceiling of the game: the tier rises as the content does.';
  }
  ...
  String calibrationResultSeeded(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count phrases from the test are already lit in your sky.',
      one: '$count phrase from the test is already lit in your sky.',
    );
    return '$_temp0';
  }
  ...
  @override
  String get ritualNewWords => 'new phrases';
  ...
  String ritualDoneBody(int lumens, int phrases) {
    String _temp0 = intl.Intl.pluralLogic(
      phrases,
      locale: localeName,
      other: '$lumens lm returned to the sky, $phrases new phrases learned.',
      one: '$lumens lm returned to the sky, $phrases new phrase learned.',
    );
    return '$_temp0';
  }
  ...
  String constellationLitOf(int lit, int total) {
    String _temp0 = intl.Intl.pluralLogic(
      lit,
      locale: localeName,
      other: '$lit of $total stars are bright',
      one: '$lit of $total stars is bright',
    );
    return '$_temp0';
  }
  ...
  String constellationToLight(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count more stars until it lights up',
      one: '$count more star until it lights up',
    );
    return '$_temp0';
  }
  ...
  String tierSuggestUp(String tier) {
    return 'Most of the constellations you have opened are lit. Move to $tier? Old stars stay where they are.';
  }
  ...
  @override
  String get profileAutomatic => 'automatic';

  @override
  String get profileWordsInWork => 'phrases in progress';
  ...
  String profileBrightOf(int bright, int total) {
    String _temp0 = intl.Intl.pluralLogic(
      bright,
      locale: localeName,
      other: '$bright of $total bright',
      one: '$bright of $total bright',
    );
    return '$_temp0';
  }
  ...
  String settingsTierLocked(String tier) {
    return 'Tiers above $tier are still drafts and are not available yet.';
  }
  ...
  @override
  String get aboutReviewTitle => 'Who wrote these phrases';
  ...
  String profileScaleHint(String tier, int percent) {
    return 'You are on $tier: $percent% of its phrases are held in memory.';
  }

  @override
  String profileScaleLocked(String tier) {
    return 'Tiers above $tier are still drafts, so the game does not offer them.';
  }
  ...
  @override
  String get stageIntroduction => 'Meeting new phrases';

  @override
  String get stageConsolidation => 'Settling in';

  @override
  String get stageCheck => 'Checking';

  @override
  String get stageReminder => 'Reminding';
  ...
  String sprintGoal(int done, int target, int seconds) {
    return '$done of $target in $seconds s';
  }

  @override
  String get sprintReached => 'Bar cleared';

  @override
  String sprintMissed(int done, int target) {
    return 'Bar not cleared: $done of $target';
  }
  ...
  String reminderDimmingTitle(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count stars are dimming',
      one: '$count star is dimming',
    );
    return '$_temp0';
  }
  ...
  String reminderDimmingIn(String constellation) {
    return 'In the “$constellation” constellation. Two minutes will bring them back.';
  }

  @override
  String get reminderDimmingBody => 'Sunrise takes two minutes.';

  @override
  String get reminderCalmTitle => 'The sky is fine';
  ...
  @override
  String get reminderChannel => 'Daily reminder';

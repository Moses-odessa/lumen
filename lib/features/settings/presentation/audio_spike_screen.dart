...
///
/// Экран разработчика: он показывается только в debug-сборке, поэтому
/// строки здесь намеренно не локализованы — переводить инструмент на
/// шесть языков значит тратить вычитку не туда.
///

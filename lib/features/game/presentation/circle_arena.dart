...
class CircleArena extends StatefulWidget {
  ...
  /// Сколько времени отсчитывает **хозяин** круга. `null` — не отсчитывает
  /// никто.
  ///
  ...
  /// полосы всего лишь не предупреждает, и такой круг честнее. Забег берёт
  /// длину окна у самого вопроса ([CircleQuestion.answerWindow]) — там же, где
  /// её берёт отсчёт.
...
class _CircleArenaState extends State<CircleArena>
  ...
  /// картинка. Оба отсчёта начинаются в одном кадре — от появления круга — и
  /// длятся одно и то же время, потому что длину обоим даёт вопрос
  /// ([CircleQuestion.answerWindow]).
  ///
